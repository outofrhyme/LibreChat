...
from core import extract_headers_from_context, parse_caller_context
from service import MemorySearchResult, create_search_service
...
def search_memory(
    ...
    """Search memory by query, locked to trusted LibreChat request context."""
